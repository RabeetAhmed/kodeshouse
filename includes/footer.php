<!-- Site Footer - Start
              ...
              <div class="col col-lg-4 col-md-6">
                <div class="footer_widget pe-lg-5">
                  <div class="site_logo">
                      ...
                      <img src="assets/images/logo/waleed.png" class="w-50" alt="Site Logo - Kodes House">
                    </a>
                  </div>
                  <p>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-7EE190RQGN"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-7EE190RQGN');
    </script>
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/647d10d37c7b15544f3ef5d1/1h248jffu';
    s1.charset='UTF-8';
